...
(function (wandDigital) {
    var Integration = (function () {
        function Integration(isLeader, isUsingIndexedDB) {
            ...
            this.apiKey = "";
            this.lastSync;
            this.minUpdate = 300000; //5 min
            this.maxUpdate = 600000; //10 nin
            this.integrationUpdateInterval = this.maxUpdate;
            this.settingsMinUpdate = 300000; //5 min
            this.settingsMaxUpdate = 600000; //10 nin
        ...
        Integration.prototype.getIntegrationData = function (action) {
            ...
            $.get(url, function (data, status, xhr) {
                ...
                .fail(function () {
                    ...
                    _this.integrationUpdateInterval = _this.attempts > 3 ? _this.integrationUpdateInterval : _this.fallbackInterval;
                    integration.showConnect(true, "forestgreen", _this.API, "Failed to sync Integration data", "error");
                    if (_this.attempts === 4) {
                        try {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            handleIndexedDB = function () {
                                return __awaiter(_this_1, void 0, void 0, function () {
                                    var _this_1 = this;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, _this.db.transaction('rw', _this.db[table], function () {
                                                return __awaiter(_this_1, void 0, void 0, function () {
        ...
        Integration.prototype.formatSimphony = function (data) {
            try {
                ...
                Object.values(condimentMap).forEach(function (modifier) {
                    ...
                    // Optionally, you can delete the original array if you don't need it anymore
                    // delete modifier.categories;
                    ...
                    if (each.comboOrder > 0) {
                        if (!comboItems[each.id]) {
                            comboItems[each.id] = {
                                ...
                                combo: true,
                                calories: "0",
                                description: "NA - Combo (does not support description)",
                                date: each.date,
                                comboItemNames: "",
